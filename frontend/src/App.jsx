 ...
 * Includes a skip-to-content link and a page-level live region for
...
function App() {
  return (
    <>
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:rounded-lg focus:bg-brandAccent focus:text-white focus:font-semibold focus:shadow-xl"
      >
        Skip to main content
      </a>

      {/* Page-level live region for future global announcements */}
      ...
      <div className="min-h-screen p-4 md:p-8 font-sans animate-fade-in relative z-10">
        ...
        <main className="grid grid-cols-1 lg:grid-cols-3 gap-8" id="main-content">
